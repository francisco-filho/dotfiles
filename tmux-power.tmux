...
user=$(whoami)
#LS="#[fg=white,bg=default] $user_icon $user@#h #[fg=$TC,bg=$G06,nobold]#[fg=$TC,bg=$G06] $session_icon #S "
LS="#[fg=white,bg=default]#[fg=$TC,bg=$G06,nobold]#[fg=$TC,bg=$G06] $session_icon #S "
...
RS="#[fg=$TC,bg=$G06] $time_icon $time_format #[fg=$TC,bg=default]#[fg=$Tj,bg=default] $date_icon $date_format "
if "$show_download_speed"; then
    RS="#[fg=$G05,bg=$BG]#[fg=$TC,bg=$G05] $download_speed_icon #{download_speed} #[fg=$G06,bg=$G05]$left_arrow_icon$RS"
fi
...
tmux_set window-status-current-format "#[fg=$BG,bg=default]$right_arrow_icon#[fg=$TC] #I:#[fg=$COLOUROK]●#[fg=$TC]#W #[fg=$G06,bg=$BG,nobold]"
